...
## Corpus Check
- 7 files · ~20,330 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 126 nodes · 149 edges · 13 communities (7 shown, 6 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a026a6e2`
...
## Knowledge Gaps
- **2 isolated node(s):** `Noto Emoji (Google)`, `Montserrat`
...
- **What connects `Noto Emoji (Google)`, `Montserrat`, `Лицо крупным планом со стрелкой на нос: сам по себе нос не читается.` to the rest of the system?**
